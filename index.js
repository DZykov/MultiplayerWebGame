...
app.use(function(req, res, next) {
    res.header("Access-Control-Allow-Origin", "https://webshooterio.netlify.app/"); // update to match the domain you will make the request from
...
const io = new Server(server, {
    cors: {
        origins: ["https://webshooterio.netlify.app/"],
